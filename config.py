...
BATTLE_STEAL_MAX_PCT = 0.02   # هر ضربه حداکثر ۲% دارایی حریف (درخواست کارفرما: از 5% رسید به 2%)
...
PRODUCT_CAP_BASE = 300        # کف ظرفیت هر محصول (درخواست کارفرما: خیلی بیشتر)
PRODUCT_CAP_PER_LEVEL = 10    # هر لول انبار اینقدر به ظرفیت هر محصول اضافه می‌کنه

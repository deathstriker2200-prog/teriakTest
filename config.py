...
# ظرفیت انبار هر لول = per_tick × ۷۲ تیک ← چوب‌بری 360 | کارخانه آهن 504، با هر ارتقا بیشتر میشه
FACTORIES = {
    "lumber": {
        "name": "چوب‌بری", "emoji": "🪵", "res": "wood",
        "per_tick": 5,              # هر لول هر تیک ۵ چوب (۳۰ چوب در ساعت روی هر لول)
    ...
    "ironmill": {
        ...
        "per_tick": 7,              # هر لول هر تیک ۷ آهن (۴۲ آهن در ساعت روی هر لول)

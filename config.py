...
# ───────── حمله پی‌وی کلاسیک ⚔️ ─────────
# کلاسیک PvP بدون HP: هر نفر دقیقاً با قدرت پروفایل خودش (حمله نهایی + دفاع نهایی) سنجیده می‌شود.
# قدرت بالاتر قطعی می‌برد، مساوی به سود مدافع است؛ بعد هر حمله قربانی ۶ ساعت مصون می‌شود.
# این سه نام برای سازگاری کدهای جانبی قدیمی مانده‌اند و دیگر رول نزدیک‌بودن وجود ندارد.
PV_ATTACK_CLOSE_DIFF = 40
PV_ATTACK_STRONG_CHANCE = 1.0
PV_ATTACK_WEAK_CHANCE = 0.0
...
# سه انرژی‌زای اول با سختی اقتصادی ۱٫۵× می‌شوند؛ بمب انرژی قیمت قطعی ۱۵۰٬۰۰۰ دارد
ENERGY_DRINKS = {
    ...
    "bomb": {"name": "💣 بمب انرژی",  "energy": None, "price": 150000, "boost": 0.30, "desc": "انرژی فول + 15 دقیقه 30% قدرت حمله بیشتر"},
}
ENERGY_BOOST_SECONDS = 900       # مدت بوست حمله بمب انرژی، ۱۵ دقیقه
...
# قیمت تیر (×۳)، درمان (×۲)، بمب انرژی (۱۵۰هزار)، دستمزد/استخدام آزمایشگاه و قیمت‌های جمی سپر

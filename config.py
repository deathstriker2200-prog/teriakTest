...
# لول‌های پایین ارزون مونده و هرچی بالاتر میری منحنی تصاعدی‌تره (درخواست کارفرما)
...
FACTORIES = {
    "lumber": {
        ...
        "up_tp": [3000, 6000, 12000, 24000, 48000, 95000, 190000, 380000, 750000],
    ...
    "ironmill": {
        ...
        "up_tp": [4500, 9000, 18000, 36000, 72000, 140000, 280000, 560000, 1100000],
...
WEAPON_ABILITY_TEXT = {
    ...
    "oblivion": "👑 هر حمله یکی از قابلیت‌های بالا به‌صورت تصادفی فعال میشه",
}
...
SKILLS = {
    ...
    "speed":   {"name": "⚡ سرعت",  "per": 0.02, "desc": "هر لول 2% کولدان حمله کمتر"},

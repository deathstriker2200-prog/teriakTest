...
PV_ATTACK_CLOSE_EDGE_CHANCE = 0.75  # شانس قوی‌تر روی لبه بازه نزدیک (راند ۱۷، درخواست کارفرما: برتری بیشتر)
...
PV_REROLL_MIN_COST = 100          # هزینه «هدف دیگه» تو لول ۱ (راند ۱۵: 100 تا 2500)
PV_REROLL_MAX_COST = 2500        # هزینه «هدف دیگه» تو مکس لول، بین اینا خطی با لول جست‌وجوگر (راند ۱۵)
PV_SPY_MIN_COST = 250           # هزینه «جاسوسی» تو لول ۱، جیب و قدرت کلی طرف رو لو میده (راند ۱۵: 250 تا 5000)
PV_SPY_MAX_COST = 5000         # هزینه «جاسوسی» تو مکس لول، بین اینا خطی با لول جست‌وجوگر (راند ۱۵)
...
ARMORS = {
    ...
    "gods":    {"name": "👑 زره خدایان",  "price": 240000, "defense": 130, "min_level": 19, "sec": "special",
                "desc": "وقتی مرگ نزدیکه برکت آسمانی نجاتت میده",
...
GODS_SAVE_CHANCE = 0.10    # 👑 خدایان: شانس نجات از ضربه مرگبار و موندن با ۱ HP (پایه)
...
ARMOR_ABILITY_TEXT = {
    ...
    "godshield": "👑 10% شانس ضربه مرگبار خنثی بشه و با 1 HP زنده بمونی",
}
...
TEAM_QUESTS = [
    ...
    # راند ۱۵ (درخواست کارفرما): انرژی خوردن و ارسال محموله و فروش منابع هم برای تیم
...
TEAM_CHAT_HISTORY = 20          # چت تیم: فقط این‌تعداد پیام آخر نگه‌داشته میشه (راند ۲۰، درخواست کارفرما)
...
# ───────── قمارخانه 🎰 ─────────
CASINO_MIN_LEVEL = 7
CASINO_COOLDOWN_MINUTES = 30       # راند ۱۹: هر نیم ساعت یه بازی (درخواست کارفرما)
CASINO_BETS = [1000, 5000, 25000]  # میزهای شرط
CASINO_STATE_TTL = 900             # بازی نیمه‌کاره بعد از این (ثانیه) می‌سوزه و شرطش برنمی‌گرده
# 🎲 شرط ساده (همون قدیمی): ۴۰% برد و ۱٫۸ برابر | ارزش انتظاری ۰٫۷۲
CASINO_WIN_CHANCE = 0.40
CASINO_WIN_MULT = 1.8
# 🎲 تاس دوبل: ۴۸% برد و ۲ برابر | ارزش انتظاری ۰٫۹۶
CASINO_DICE_CHANCE = 0.48
CASINO_DICE_MULT = 2.0
# 🎡 گردونه شانس: (ضریب, وزن) | ارزش انتظاری تقریبا ۰٫۸۴
CASINO_WHEEL = [(0.0, 30), (0.5, 25), (1.0, 20), (1.5, 12), (2.0, 8), (3.0, 4), (5.0, 1)]
# 🃏 کارت بالا/پایین: هر حدس درست ضریب = این کسر از ضریب منصفانه واقعی (ارزش انتظاری هر پله ۰٫۸۵)
CASINO_CARD_MARGIN = 0.85
CASINO_CARD_STEP_CAP = 1.9         # سقف ضریب هر پله که کارتای خیلی راحت بازی رو منفجر نکنن
CASINO_CARD_MAX_STEPS = 5          # بعدش خودکار کش‌اوت
# 💣 مین: هر لول (شانس بمب، ضریب کش‌اوت) | ارزش انتظاری هر لول زیر ۱ و هرچی عمیق‌تر ریسک بیشتر
CASINO_MINES_LEVELS = [
    (0.20, 1.10),
    (0.27, 1.20),
    (0.34, 1.75),
...
CASINO_MINES_CELLS = 3             # هر لول چند خونه دکمه داره

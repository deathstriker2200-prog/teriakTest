...
def register_handlers(app: Application) -> None:
    ...
    app.add_handler(CommandHandler("lab", lab.lab_cb))
    ...
    # ── آزمایشگاه: همه اکشن‌های خرج/تولید/فروش دو مرحله‌ای و تاییددار ──
    app.add_handler(CallbackQueryHandler(lab.lab_build_cb, pattern=r"^lab:build$"))
    app.add_handler(CallbackQueryHandler(lab.lab_build_execute, pattern=r"^cf:lab:build$"))
    ...
    app.add_handler(CallbackQueryHandler(lab.lab_fire_execute, pattern=r"^cf:lab:fire:\d+$"))
    ...
    app.add_handler(CallbackQueryHandler(lab.lab_start_confirm_cb, pattern=r"^lab:pick:\d+:\w+$"))
    ...
    app.add_handler(CallbackQueryHandler(lab.lab_ship_confirm, pattern=r"^lab:ship:\w+:\d+$"))
    app.add_handler(CallbackQueryHandler(lab.lab_ship_execute, pattern=r"^cf:lab:ship:\w+:\d+$"))
    # پیام‌های قدیمی فروش مستقیم فقط به انبار برمی‌گردند و پولی واریز نمی‌کنند

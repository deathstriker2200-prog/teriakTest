...
HELP_SECTIONS: dict[str, str] = {
    ...
    "team": (
        '<b>👥 تیم</b>\n\nساخت تیم از لول 5 به بعد باز میشه و هزینه ساخت تیم 50,000 تی\u200cپوینت هست\n\nاز لول 3 می\u200cتونی با دستور «جوین تیم [نام تیم]» درخواست عضویت برای تیم\u200cها ارسال کنی\nدرخواست باید توسط رهبر یا مدیران اون تیم تأیید یا رد بشه\n\n⭐ لول تیم\nتیم\u200cها هم مثل بازیکن\u200cها لول دارن؛ هر تجربه\u200cای که اعضا دریافت می\u200cکنن، به تجربه تیم هم اضافه میشه\nبا افزایش لول تیم، ظرفیت اعضا بیشتر میشه و امکان ارتقای ساختمان\u200cهای تیم هم افزایش پیدا می\u200cکنه\n\n👑 مدیریت تیم\nرهبر و مدیران از بخش 👑 مدیریت تیم می\u200cتونن تیم رو کنترل کنن\n\nمدیریت درخواست\u200cها با دکمه یا دستور انجام میشه\n\n«تیم درخواست @یوزر قبول/رد»\n\n🚫 حذف عضو\n\n«تیم کیک @یوزر»\n\n👤 اضافه کردن مدیر\n\n«تیم اد ادمین @یوزر»\n\n❌ حذف مدیر\n\n«تیم حذف ادمین @یوزر»\n\nرهبر تیم می\u200cتونه برای کمک در مدیریت، اعضای مورد اعتمادش رو به عنوان مدیر انتخاب کنه\n\n🏆 فعالیت\u200cهای تیمی\nکوئست روزانه تیم و کنده\u200cکاری تیمی به تمام اعضا جایزه میدن\n\n🥇 آخر هر هفته تیم\u200cهای برتر بر اساس عملکردشون رتبه\u200cبندی میشن و جایزه دریافت می\u200cکنن'
    ),
    "resources": (
        "<b>🎒 منابع</b>\n\n"

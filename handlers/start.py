...
HELP_SECTIONS: dict[str, str] = {
    ...
    "farm": (
        ...
        "بعد رشد با «تریاکی برداشت» محصولت میره تو 🎒 انبارت\n\n"
        "هر برداشت یه تعداد شانسی محصول میگیری، افسانه‌ای‌ها همیشه 1 تا\n"
        "بقیه بین 1 تا 6 تا بر اساس لول زمین، هرچی زمین لول بالاتر شانس تعداد زیادتره\n"
        "آب‌وهوا و بازار هم روی درآمدت اثر می‌ذارن\n\n"
        "⬆️ ارتقای زمین سرعت رشد رو بیشتر می‌کنه\n"
        ...
        "محصول بعد برداشت نقد نمیشه؛ از بخش 📦 ارسال محموله انبار با محموله می‌فرستی\n"
        "یا به کاروان قاچاق گرون‌تر می‌فروشی، توضیحش بخش خودش رو داره"
    ),
    "dogs": (
        "<b>🐕 سگ‌ها</b>\n\n"
    ...
    "shelter": (
        "<b>🎒 انبار</b>\n\n"
        "انبارت سه دسته داره\n"
        "🌾 محصولات، هرچی از مزرعه برداشت می‌کنی اینجا میان\n"
        "🧱 منابع، چوب و آهن با نوار پرشوندگی\n"
        "📦 آیتم‌ها، بذرهات و بعداً جعبه و کلید و بلیت\n\n"
        "با هر ارتقا ظرفیت بذر و چوب و آهن بیشتر میشه، هر ارتقا سطح خودشو می‌خواد\n"

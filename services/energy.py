...
سه نوشیدنی شارژ (25 | 50 | 100) و بمب انرژی: انرژی فول + 30% قدرت حمله به مدت ۱۵ دقیقه
بوست روی کاربر ذخیره میشه (boost_until) و combat_boost_pcts فقط به استت حمله‌اش اعمالش می‌کنه
در قدرت متقارن پروفایل/PvP، هر بازیکنی که بوست فعال داشته باشد از آن سود می‌برد
